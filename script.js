...
// Scene 2 =============================================================================================================
const letterText = {
	date: 'Hà Nội, ngày 25 tháng 4 năm 2026',
	greeting: 'Gửi em,',
	line1: 'Dù chúng ta chỉ mới quen nhau và chưa lần nào gặp mặt, nhưng mỗi lần trò chuyện với em đều khiến anh thấy rất vui và mong chờ.',
	line2: 'Ngày hôm nay, khi chúng ta gặp nhau, anh chỉ muốn nói với em rằng: anh thật sự có cảm tình với em.',
